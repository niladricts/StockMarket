...
class StockMarket:
    ...
    @staticmethod
    def get_upward_trend(df: PandasDataFrame, start_dt: datetime, end_dt: datetime) -> NoReturn:
        trend_days = 0
    ...
    @staticmethod
    def get_sma_5_days_opening(dft: PandasDataFrame, name: str) -> NoReturn:
        """
    ...
    def get_data(self, dt1: datetime, dt2: datetime, opt: int, stkname: str) -> NoReturn:
        ...
        if opt == 1:
            ...
            self.get_upward_trend(data, date01, date02)
        # elif opt == 2:
        # self.get_highest_trading_with_stock(data, date01, date02)
        elif opt == 3:
            self.get_sma_5_days_opening(data, stkname)
        else:
            print("Bad Option")
            exit(0)
        exit(0)
